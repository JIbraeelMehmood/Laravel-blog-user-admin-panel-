...
//MULTI-AUTH
    Route::get('/admin_dashboard', 'Dashboard\AdminController@index')->middleware('rolebase:admin');
    #Route::get('/post/acceptBlog/{id}',[AdminController::class,'acceptBlog'])->name('acceptBlog');
...
//=========================================================================================
    Route::get('/user_dashboard','Dashboard\UserController@index')->middleware('rolebase:user');
